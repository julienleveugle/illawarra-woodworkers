...
Use the menu to the left to navigate around the site. The location of the workshop and directions to find us are shown on the [Location](/location) page, we have details of the exhibitions and club events in the [Events Calendar](/events-calendar) and a wide selection of useful [Web Links](/web-links) for woodworkers.
...
The Illawarra Woodworkers have for many years also made toys that are [Donations](/donations) to local charities to either use directly or in their own fund raising activities.
...
![Bendigo Bank Logo](/images/stories/bendigo_logo.jpg)
